...
<?php if ( have_comments() ) : ?>
	...
	<h3> <span><?php comments_number(''.get_option('ptthemes_comment_responsesa_name').'', ''.get_option('ptthemes_comment_responsesb_name').'', ''.get_option('ptthemes_comment_responsesc_name').'' );?> </span>   </h3>
...
<div id="respond">
    ...
    <h3> <span><?php comment_form_title( ''.get_option('ptthemes_comment_reply_name').'', ''.get_option('ptthemes_comment_reply_name').' &rarr; %s' ); ?></span> </h3>
