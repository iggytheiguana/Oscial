                         ...
                         <?php if ( get_option( 'ptthemes_postcontent_full' )) { ?>
                            ...
                            <?php } else { ?>
                                ...
                                <?php if(get_post_meta($post->ID,'featured',true)){?>
                                     <img src="<?php echo bloginfo('template_url'); ?>/thumb.php?src=<?php echo get_post_meta($post->ID,'featured',true);?>&amp;w=190&amp; h=150&amp; zc=1&amp;q=80<?php echo $thumb_url;?>" alt="<?php the_title(); ?>"  class="imgleft" />   <?php } else  if($post_images[0]){?>
