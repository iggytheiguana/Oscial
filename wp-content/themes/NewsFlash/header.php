...
<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/library/css/slider.css"  type="text/css" />
...
<div id="top_stirp_in">
     ...
     <p class="links"> <a href="<?php if( get_option('ptthemes_feedburner_url')){echo get_option('ptthemes_feedburner_url');}else{ echo bloginfo('rss_url');} ?>"><img src="<?php bloginfo('template_directory'); ?>/images/i_rss.png" alt=""  /> </a> 
     
      <?php if ( get_option('ptthemes_twitter_id') != "") { ?>
 		 <a href="<?php echo stripslashes(get_option('ptthemes_twitter_id'));  ?>"><img src="<?php bloginfo('template_directory'); ?>/images/i_twitter.png" alt=""  /> </a>
        <?php } ?>
        
         <?php if ( get_option('ptthemes_facebook_id') != "") { ?>
 		 <a href="<?php echo stripslashes(get_option('ptthemes_facebook_id'));  ?>"><img src="<?php bloginfo('template_directory'); ?>/images/i_facebook.png" alt=""  /> </a>
        <?php } ?>
