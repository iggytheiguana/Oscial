...
$options[] = array(	"type" => "maintabletop");
    ...
    /// General Settings
	    ...
	    $options[] = array(	"name" => "General Settings",
			...
			$options[] = array(	"name" => "Upload Favicon",
						        "toggle" => "true",
								"type" => "subheadingtop");
			...
			$options[] = array(	"name" => "Upload Logo",
                ...
                $options[] = array(	"name" => "Choose Your full banner image",
				                    "desc" => "Paste the full URL to your logo image here. (Logo image size - 980x150px)",
			...
			$options[] = array(	"name" => "Syndication / Feed ID  <br> &nbsp;  &nbsp;  &nbsp; (ex.templatic)",
			 ...
			 $options[] = array(	"type" => "subheadingbottom");
				...
				$options[] = array(	"name" => "Twitter Full URL",
						        "toggle" => "true",
								"type" => "subheadingtop");	
			
			
				$options[] = array( "desc" => "Twitter full URl Link (http://twitter.com/templatic)",
			...
			$options[] = array(	"type" => "subheadingbottom");
				...
				$options[] = array(	"name" => "Facebook Full URL",
						        "toggle" => "true",
								"type" => "subheadingtop");	
			
			
				$options[] = array( "desc" => "Facebook full URl Link (http://facebook.com/templatic)",
...
$options[] = array(	"name" => "Include Categories for Header Navigation",
						        "toggle" => "true",
								"type" => "subheadingtop");
						
				$options[] = array(	"label" => "Header Navigation",
                	                "desc" => "Enter a comma-separated list of the <code>categories ID's</code> that you'd like to display in header (bottom category Navigation). (ie. <code>1,2,3,4</code>)",
...
$options[] = array(	"name" => "Footer Navigation",
		...
		$options[] = array(	"name" => "Other design Settings",
						    "type" => "heading");
										
				$options[] = array(	"name" => "Header Top Banner URL link",
						        "toggle" => "true",
								"type" => "subheadingtop");
						
				$options[] = array(	"label" => "Header Top Banner URL Link",
                	                "desc" => "",
			...
			$options[] = array(	"name" => "Show Single Page Featured Image Gallery ?",
						        "toggle" => "true",
								"type" => "subheadingtop");
						
				$options[] = array(	"label" => "Hide Featured Gallery Section",
						            "desc" => "Check box to hide featured gallery section",
						            "id" => $shortname."_featured_gallery",
						            "std" => "true",
						            "type" => "checkbox");	
